    ...
    <div className="min-h-screen bg-cream py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-sand p-6 rounded-card shadow-card">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-cream rounded-card flex items-center justify-center">
          ...
          <div className="bg-sand p-6 rounded-card shadow-card">
            ...
            <Link to="/admin/profils" className="text-sm text-orange hover:text-orange-dark mt-2 inline-block font-inter font-text-medium">
              Voir les profils →
            </Link>
          </div>
        ...
        {/* Actions rapides */}
        <div className="bg-sand rounded-card shadow-card p-6 mb-8">
          <h2 className="text-xl font-poppins font-title-bold text-navy mb-4">Actions rapides</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link
              to="/admin/profils"
              className="flex items-center p-4 border border-gray-warm rounded-card hover:bg-cream transition"
            >
              <div className="w-12 h-12 bg-orange rounded-card flex items-center justify-center text-navy text-xl">
                📋
              </div>
              <div className="ml-4">
            ...
            <button
              ...
              className="flex items-center p-4 border border-gray-warm rounded-card hover:bg-cream transition text-left"
            >
              <div className="w-12 h-12 bg-orange rounded-card flex items-center justify-center text-navy text-xl">
                📊
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-sand rounded-card shadow-card p-6">
            <h2 className="text-xl font-poppins font-title-bold text-navy mb-4">Répartition par catégorie</h2>
          ...
          <div className="bg-sand rounded-card shadow-card p-6">
            <h2 className="text-xl font-poppins font-title-bold text-navy mb-4">Inscriptions (6 derniers mois)</h2>
        ...
        {/* Profils récents */}
        <div className="mt-8 bg-sand rounded-card shadow-card p-6">
          <h2 className="text-xl font-poppins font-title-bold text-navy mb-4">Dernières inscriptions</h2>
            ...
            <table className="min-w-full divide-y divide-gray-warm">
              ...
              <tbody className="bg-sand divide-y divide-gray-warm">
                {stats?.recentProfiles?.map((profile) => (
                  ...
                  <tr>
                    <td colSpan="5" className="px-6 py-4 text-center text-text font-inter font-text">
