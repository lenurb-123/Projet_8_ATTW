      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-sand p-6 rounded-card shadow-card">
            <h3 className="text-sm font-inter font-text-medium text-gray-warm mb-2">Statut du profil</h3>
            ...
            <Link
              to="/usager/statut"
              className="mt-4 text-orange hover:text-orange-dark text-sm inline-block font-inter font-text-medium">
              Voir les détails →
            </Link>
          </div>
          ...
          {/* Carte Profil */}
          <div className="bg-sand p-6 rounded-card shadow-card">
            <h3 className="text-sm font-inter font-text-medium text-gray-warm mb-2">Complétude du profil</h3>
            <div className="flex items-center">
        ...
        <div className="bg-sand rounded-card shadow-card p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link
              ...
              className="flex items-center p-4 border-2 border-gray-warm rounded-card hover:border-orange hover:bg-cream transition"
            >
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-warm font-inter">Mettez à jour vos informations</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500">Voir l'état de votre demande</p>
              </div>
            </Link>
          </div>
        </div>
        ...
        {profile && (
          <div className="bg-sand rounded-card shadow-card p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <Link
                to="/usager/profil/edit"
                className="text-orange hover:text-orange-dark text-sm font-inter font-text-medium">
                Modifier
              </Link>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-6 flex-1">
                ...
                <p className="text-gray-600 mt-1">{profile.category}</p>
